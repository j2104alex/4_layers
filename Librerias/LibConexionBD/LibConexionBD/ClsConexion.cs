...
using System.Data;
using System.Data.SqlClient; //Son los proveedores de SQL (CONECTION,COMMAND,DATAREADER,DATAADAPTER)
using LibParametro;
...
namespace LibConexionBD
{
    public class ClsConexion
    {
        ...
        //Significa que es boolean (bln) abierta o cerrada la conexion
        private bool blnBDAbierta;
        //cadena de conexion 
        //la libreria parametros, se encuentran los datos de cadena de conexion y sirve la libreria 
        //parametros para leerlos y enviar la cadena de conexion
        private string strCadenaCnx; //se almacena lo que fue enviado de la libreria parametros
        ...
        // el metodo Consultar consultar, es la sentencia usada para consultar y parametros
        public bool Consultar(string SentenciaSQL, bool blnCon_Parametros)
        {
            // el metodo consultar, es la sentencia usada para consultar y parametros
            //se va a implementar cada que se necesite consultar una informacion especifica
            if (SentenciaSQL == "")
            {
            ...
            try
            {
                //metodo para consultar ExecuteReader()
        ...
        public bool EjecutarSentencia(string SentenciaSQL, bool blnCon_Parametros)
        {
            ...
            try
            {
                //ExecuteNonQuery el metodo para:
